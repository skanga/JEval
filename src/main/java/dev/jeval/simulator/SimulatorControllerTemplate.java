...
public final class SimulatorControllerTemplate {
    private SimulatorControllerTemplate() {
    }

    public static String checkExpectedOutcome(String previousConversation, String expectedOutcome) {
        return """
                ...
                %s
                JSON Output:
                """.formatted(expectedOutcome, previousConversation);
    }
}
