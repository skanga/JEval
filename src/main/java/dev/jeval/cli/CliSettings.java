...
final class CliSettings {
    ...
    private static java.util.Set<String> knownSettingKeys() {
        ...
        keys.addAll(List.of(
                "ANTHROPIC_API_KEY", "APP_ENV", "AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY",
                "AWS_SESSION_TOKEN", "AZURE_OPENAI_AD_TOKEN",
                "AZURE_OPENAI_API_KEY", "CONFIDENT_API_KEY", "CONFIDENT_BASE_URL",
                "DEEPSEEK_API_KEY", "GEMINI_COST_PER_INPUT_TOKEN", "GEMINI_COST_PER_OUTPUT_TOKEN", "GOOGLE_API_KEY",
                "GOOGLE_SERVICE_ACCOUNT_KEY", "GROK_API_KEY", "LITELLM_API_KEY",
                "LITELLM_PROXY_API_KEY", "LM_STUDIO_API_KEY", "LM_STUDIO_MODEL_NAME",
                "LOCAL_EMBEDDING_API_KEY", "LOCAL_MODEL_API_KEY",
                ...
                "ENV_DIR_PATH", "PYTHONPATH", "TOKENIZERS_PARALLELISM", "TRANSFORMERS_NO_ADVISORY_WARNINGS",
                "VERTEX_AI_MODEL_NAME", "VLLM_API_KEY", "VLLM_MODEL_NAME"));
        return keys;
    }
