...
public final class JEvalCli {
    ...
    private static void usage(PrintStream err) {
        ...
        err.println("       jeval set-openai|set-azure-openai|set-anthropic|set-gemini|set-grok|set-moonshot|set-deepseek|set-litellm|set-portkey|set-ollama|set-local-model|set-openrouter ... [-s|--save dotenv:.env]");
