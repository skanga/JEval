...
public final class SIMBATemplate {
    private SIMBATemplate() {
    }

    public static String generateIntrospectionRewrite(
            String originalPrompt,
            String worseTrajectory,
            String betterTrajectory,
            boolean listFormat) {
        ...
        var exampleInstruction = listFormat
                ? """
                        [{"role": "system", "content": "You are a highly precise analytical engine. Always map out variables step-by-step before calculating..."},{"role": "user", "content": "{{input}}"}]"""
                : """
                        "You are a highly precise analytical engine. Always map out variables step-by-step before calculating. Input: {{input}}\"""";

        return """
                You are the core Introspective Rewriter Engine for SIMBA (Stochastic Introspective Mini-Batch Ascent), operating within a world-class prompt optimization framework.
                ...
                **
                ...
                JSON:
                """.formatted(originalPrompt, worseTrajectory, betterTrajectory, formatInstruction, exampleInstruction);
    }
}
