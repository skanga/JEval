...
- DeepEval-style local run artifacts under `.deepeval`, including `.latest_run_full.json`, timestamped `test_run_YYYYMMDD_HHMMSS.json` files, and `_2`/`_3` collision suffix numbering
