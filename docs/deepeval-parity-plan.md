...
- CLI/test-runner latest test-run data preserves single-turn tags and comments from inline specs and JSONL dataset-loaded cases
...
- CLI/test-runner latest test-run data preserves single-turn token cost and completion time from inline specs and JSONL dataset-loaded cases
- CLI/test-runner latest test-run data preserves single-turn custom column values from inline specs and JSONL dataset-loaded cases
...
- CLI/test-runner latest test-run data preserves single-turn trace payloads from inline specs and JSONL dataset-loaded cases
