...
- Conversation simulator utility surface for first/next simulated user input generation, structured simulator-model JSON parsing, language defaults, and assistant callback invocation
