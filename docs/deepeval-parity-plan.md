...
- Optimizer algorithm configuration surfaces for SIMBA, COPRO, and GEPA with DeepEval-style defaults, seeded random state handling, tie-breaker policy enum, and GEPA bounds validation
