...
- `EvaluationDataset` single-turn synthetic golden generation helpers for source-file-aware contexts, documents, scratch prompts, and stored goldens using a supplied synthesizer, including Java `CompletableFuture` async wrappers
