...
- Optimizer algorithm configuration surfaces for SIMBA, COPRO, and GEPA with DeepEval-style defaults, seeded random state handling, tie-breaker policy enum, GEPA bounds validation, and `pickBestWithTies` policy helper
